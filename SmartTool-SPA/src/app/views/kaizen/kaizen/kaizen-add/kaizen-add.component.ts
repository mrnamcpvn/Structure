...
export class KaizenAddComponent implements OnInit {
  ...
  ngOnInit() {
    this._kaizenService.modelNameSource.subscribe(
      (modelName) => (this.modelName = modelName)
    );
    this._kaizenService.modelNoSource.subscribe(
      (modelno) => (this.Model_no = modelno)
    );
    this.getListStage();
  ...
  getListProcess() {
    this._kaizenService
      .getProcess(this.Model_no, this.stage)
      .subscribe((res) => {
  ...
  getListOpera() {
    this._kaizenService
      .getOpera(this.Model_no, this.stage, this.process)
      .subscribe((res) => {
