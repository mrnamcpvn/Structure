...
@Component({
  selector: 'app-group-kaizen-detail',
  templateUrl: './group-kaizen-detail.component.html',
  styleUrls: ['./group-kaizen-detail.component.scss']
})
export class GroupKaizenDetailComponent implements OnInit {
  kaizen: any;
