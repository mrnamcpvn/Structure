...
export class GroupKaizenReportService {
    ...
    getSeasonByUpper(factory_id: string, upperId: string) {
        return this.http.get<string[]>(this.baseUrl + 'groupKaizenReport/getSeason', { params: { factory_id: factory_id, upper_id: upperId } });
    }
