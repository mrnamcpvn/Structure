...
export class GroupKaizenReportService {
  ...
  search(
    ...
    return this.http
      .post<any>(this.baseUrl + "groupKaizenReport/search/", text, {
        observe: "response",
        params,
      })
      .pipe(
  ...
  searchModel(pagination: Pagination, text?: any) {
    let params = new HttpParams();
    ...
    return this.http.post<PaginatedResult<any[]>>(
      `${API}groupKaizenReport/search/`,
      text,
      { params }
    );
  }
  ...
  exportExcel(param: any) {
    return this.http
      .post(this.baseUrl + "groupKaizenReport/exportExcel", param, {
        responseType: "blob",
      })
  ...
  getSeasonByUpper(factory_id: string, upper_id: string) {
    return this.http.get<string[]>(
      this.baseUrl + "groupKaizenReport/getSeason",
  ...
  getDataChart(factory_id: string, upper_id: string, season: string) {
    return this.http.get<Efficiency[]>(
      this.baseUrl + "groupKaizenReport/getEfficiencys",
  ...
  getKaizens(
    ...
    return this.http
      .get<any>(this.baseUrl + "groupKaizenReport/getKaizens", {
        observe: "response",
        params,
      })
      .pipe(
  ...
  getKaizens2(pagination: Pagination, factory_id?: string, model_no?: string) {
    let params = new HttpParams();
    if (pagination.currentPage != null && pagination.pageSize != null) {
      params = params.append("pageNumber", pagination.currentPage.toString());
      params = params.append("pageSize", pagination.pageSize.toString());
    ...
    return this.http.get<PaginatedResult<any[]>>(
      `${API}groupKaizenReport/getKaiZens2/`,
      { params }
    );
  }
  ...
  updateClickTimes(data: any) {
    return this.http.post(
      this.baseUrl + "groupKaizenReport/updateClickTimes",
      data,
      {}
    );
  }
  ...
  getKaizenDetail(factory_id: string, model_no: string, serial_no: string) {
    return this.http.get<any>(
      this.baseUrl + "groupKaizenReport/getkaizenDetail",
      {
        params: {
  ...
  getFactory() {
    return this.http.get(this.baseUrl + "groupKaizenReport/getFactory", {
      responseType: "text",
    });
  }
  addCross(model: KaizenBenefitsApplicationForm) {
    return this.http.post<OperationResult>(
      this.baseUrl + "groupKaizenReport/addCrossSiteSharing",
      model
    );
  }
}
