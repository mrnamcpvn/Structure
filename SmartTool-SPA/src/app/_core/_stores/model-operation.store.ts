...
@StoreConfig({ name: "model operation", idKey: '_id', deepFreezeFn: obj => obj }) //in dev mode, we deep freeze the store, so that you don't mutate it => temporary solution : deepFreezeFn: obj => obj
