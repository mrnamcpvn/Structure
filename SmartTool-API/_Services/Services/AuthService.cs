...
namespace SmartTool_API._Services.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IUserRepository repoUsers, IRoleRepository repoRoles, IRoleUserRepository repoRoleUser)
        {
        ...
        public async Task<UserForLoggedDTO> GetUser(string username, string password)
        {
            ...
            => new RolesDTO { Name = y.role_unique, Position = y.role_sequence }).ToListAsync();
