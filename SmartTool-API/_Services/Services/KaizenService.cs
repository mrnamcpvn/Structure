...
namespace SmartTool_API._Services.Services
{
    public class KaizenService : IKaizenService
    {
        ...
        public KaizenService(IMapper mapper, MapperConfiguration configMapper, IKaizenRepository kaizen, IModelRepository modelRepository, IStageRepository stageRepository, IFactoryRepository factoryRepository, IModelOperationRepository modelOperationRepository, IProcessTypeRepository processTypeRepository)
        {
            _mapper = mapper;
        ...
        public async Task<KaizenDTO> GetKaizenEdit(string modelNo, string serialNo, string factory)
        {
            ...
            var data = await (from a in Kaizen
                            join b in model on new {Factory =a.factory_id,model_no =a.model_no,Stage = a.stage_id
