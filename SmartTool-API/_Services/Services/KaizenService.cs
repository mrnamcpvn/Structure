...
namespace SmartTool_API._Services.Services
{
    public class KaizenService : IKaizenService
    {
        ...
        public Task<PagedList<KaizenDTO>> GetWithPaginations(PaginationParam param)
        {
            throw new System.NotImplementedException();
        }

        public Task<PagedList<KaizenDTO>> Search(PaginationParam param, object text)
        {
            throw new System.NotImplementedException();
        }

        public async Task<PagedList<KaizenDTO>> Search(PaginationParam param, string model_no,string factory)
