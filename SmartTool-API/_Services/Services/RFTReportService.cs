...
namespace SmartTool_API._Services.Services
{
    public class RFTReportService : IRFTReportService
    {
        ...
        public RFTReportService(
            IModelRepository repoModel,
            IViewRFTReportDetailRepository repoViewRFTReport,
        ...
        public async Task<PagedList<Model>> SearchRFTReport(PaginationParam paginationParam, RFTReportParam rftReportParam)
        {
            if (!string.IsNullOrEmpty(rftReportParam.factory_id))
                _configuration.GetSection("AppSettings:DataSearch").Value = rftReportParam.factory_id.Trim();
            ...
            _configuration.GetSection("AppSettings:DataSearch").Value = "";
            return PagedList<Model>.Create(data, paginationParam.PageNumber, paginationParam.PageSize);
