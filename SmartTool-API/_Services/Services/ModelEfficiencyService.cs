...
namespace SmartTool_API._Services.Services
{
    public class ModelEfficiencyService : IModelEfficiencyService
    {
        ...
        public async Task<bool> CheckExist(ModelEfficiencyEditParam modelParam)
        {
            return await _repoModelEficiency.CheckExists(modelParam);
        }
        ...
        public async Task<bool> UpdateOrInsert(List<ModelEfficiencyDTO> modelEfficiencyDTOs, string factory, string username)
        {
            foreach (var efficiency in modelEfficiencyDTOs)
            {
