...
namespace SmartTool_API._Services.Interfaces
{
    ...
    {
        Task<PageListUtility<Model>> Search(PaginationParams param,KaizenReportParam filter, string factory_id);
        ...
        Task<PageListUtility<KaizenModelDetail>> GetKaiZens(PaginationParams param,string factory_id, string model_no, bool isPaging = true);
