...
{
    public class EfficiencyRepository : MainRepository<Efficiency, string>, IEfficiencyRepository
    {
        private readonly DataContext _context;

        public EfficiencyRepository(DataContext context, IConfiguration configuration) : base(context, configuration)
        {
            _context = context;
        }
