...
namespace SmartTool_API._Repositories.Repositories
{
    public class KaizenBenefitsApplicationFormRepository : MainRepository<Kaizen_Benefits_Application_Form>, IKaizenBenefitsApplicationFormRepository
    {
        ...
        public KaizenBenefitsApplicationFormRepository(DataContext context, SHCDataContext SHCcontext, IConfiguration configuration) : base(context, SHCcontext, configuration)
        {
