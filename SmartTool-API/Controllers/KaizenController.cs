...
namespace SmartTool_API.Controllers
{
    ...
    public class KaizenController : ControllerBase
    {
        ...
        [HttpGet("getkaizenform")]
        public async Task<IActionResult> GetAllKaizenForm()
        {
        ...
        public async Task<IActionResult> Create([FromBody] KaizenDTO kaizenDTO)
        {
            ...
            if (kaizenDTO.before_media != null)
            {
                ...
                string folder = _iWebHostEnvironment.WebRootPath + "\\uploaded\\" + factory + "\\Kaizen\\" + kaizenDTO.model_no + "\\Before\\";
                string base64 = "";
                var fileName = "";
            ...
            if (kaizenDTO.after_media != null)
            {
                ...
                string folder = _iWebHostEnvironment.WebRootPath + "\\uploaded\\" + factory + "\\Kaizen\\" + kaizenDTO.model_no + "\\After\\";
                string base64 = "";
                var fileName = "";
