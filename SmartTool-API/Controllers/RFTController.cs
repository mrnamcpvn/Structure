...
namespace SmartTool_API.Controllers
{
    ...
    public class RFTController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllMeasure([FromQuery] PaginationParam param, string modelNo, string stage)
        {
        ...
        public async Task<IActionResult> GetProcessNOperationForEdit(string model_no, string stage_id, string operation_id) => Ok(await _iRFTService.GetProcessNOperation(model_no, stage_id, operation_id));
        ...
        public async Task<IActionResult> GetOptionName(string model_no, string stage_id, string process_id) => Ok(await _iRFTService.GetOperationName(model_no, stage_id, process_id));
        ...
        public async Task<IActionResult> CreateRFT(Measurement_RFTDTO measurement_RFTDTO)
        {
            ...
            if (await _iRFTService.Add(measurement_RFTDTO)) return NoContent();
        ...
        public async Task<IActionResult> UpdateRFT(Measurement_RFTDTO measurement_RFTDTO)
        {
            measurement_RFTDTO.update_by = GetUserClaim();
            measurement_RFTDTO.update_time = DateTime.Now;
            if (await _iRFTService.Update(measurement_RFTDTO)) return NoContent();
