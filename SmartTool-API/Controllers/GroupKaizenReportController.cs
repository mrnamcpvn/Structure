...
namespace SmartTool_API.Controllers
{
    ...
    public class GroupKaizenReportController : ControllerBase
    {
        ...
        [HttpPost("search")]
        public async Task<IActionResult> Search([FromQuery]PaginationParam param,KaizenReportGroupParam filterParam) {
        ...
        [HttpGet("getKaiZens")]
        public async Task<IActionResult> GetKaiZens([FromQuery]PaginationParam param,string factory_id, string model_no) {
