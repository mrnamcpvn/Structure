...
namespace SmartTool_API.Controllers
{
    ...
    public class GroupKaizenReportController : ControllerBase
    {
        ...
        public GroupKaizenReportController(IGroupKaizenReportService service, IKaizenReportService serviceKaizenReport, IWebHostEnvironment webHostEnvironment, IConfiguration configuration)
        {
            _service = service;
